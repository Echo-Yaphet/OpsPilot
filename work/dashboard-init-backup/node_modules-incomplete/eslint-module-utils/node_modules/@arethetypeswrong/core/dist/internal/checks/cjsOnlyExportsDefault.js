...
export default defineCheck({
    ...
    execute: ([implementationFileName, resolutionKind], context) => {
        ...
        const host = (_c = context.hosts.findHostForFiles([implementationFileName])) !== null && _c !== void 0 ? _c : context.hosts.bundler;
        const sourceFile = host.getSourceFile(implementationFileName);
        if (!sourceFile.externalModuleIndicator &&
            sourceFile.commonJsModuleIndicator &&
            ((_b = (_a = sourceFile.symbol) === null || _a === void 0 ? void 0 : _a.exports) === null || _b === void 0 ? void 0 : _b.has(ts.InternalSymbolName.Default)) &&
