...
export default defineCheck({
    ...
    execute: ([typesFileName, implementationFileName], context) => {
        ...
        function getImplHasDefault() {
            var _a, _b, _c, _d, _e;
            var _f;
            return ((_f = implHasDefault) !== null && _f !== void 0 ? _f : (implHasDefault = ((_b = (_a = implementationSourceFile === null || implementationSourceFile === void 0 ? void 0 : implementationSourceFile.symbol) === null || _a === void 0 ? void 0 : _a.exports) === null || _b === void 0 ? void 0 : _b.has(ts.InternalSymbolName.Default)) ||
                ((_c = getImplProbableExports()) === null || _c === void 0 ? void 0 : _c.some((s) => s.name === "default")) ||
                (!!((_e = (_d = implementationSourceFile.symbol) === null || _d === void 0 ? void 0 : _d.exports) === null || _e === void 0 ? void 0 : _e.size) &&
                    getImplChecker()
