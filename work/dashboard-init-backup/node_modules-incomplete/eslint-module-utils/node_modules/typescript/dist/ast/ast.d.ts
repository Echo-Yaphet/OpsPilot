...
import type { AssertionExpression, BindingElement, CaseClause, ComputedPropertyName, Decorator, DefaultClause, DoStatement, EndOfFile, EntityName, EnumMember, Expression, ExpressionStatement, ForInStatement, ForOfStatement, ForStatement, Identifier, IfStatement, JsxAttribute, JsxExpression, JsxSpreadAttribute, KeywordSyntaxKind, ModifierSyntaxKind, ParameterDeclaration, PropertyAccessExpression, PropertyAssignment, PropertyDeclaration, PropertySignatureDeclaration, PunctuationSyntaxKind, ReturnStatement, SatisfiesExpression, ShorthandPropertyAssignment, SpreadAssignment, Statement, SwitchStatement, TemplateSpan, ThisExpression, ThrowStatement, Token, VariableDeclaration, WhileStatement, WithStatement } from "./ast.generated.ts";
...
export type HasExpression = ExpressionStatement | IfStatement | DoStatement | WhileStatement | ReturnStatement | WithStatement | SwitchStatement | CaseClause | DefaultClause | ThrowStatement | AssertionExpression | TemplateSpan | ComputedPropertyName | Decorator | JsxExpression | JsxSpreadAttribute | SpreadAssignment | SatisfiesExpression;
