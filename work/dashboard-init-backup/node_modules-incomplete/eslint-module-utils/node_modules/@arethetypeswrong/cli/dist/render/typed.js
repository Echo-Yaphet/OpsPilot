...
export async function typed(analysis, { emoji = true, summary = true, format = "auto", ignoreRules = [], ignoreResolutions = [] }) {
    ...
    const getCellContents = memo((subpath, resolutionKind) => {
        ...
        const moduleResult = entrypoint.isWildcard
            ? "(wildcard)"
            : (!emoji ? "OK " : "🟢 ") +
                moduleKinds[((_b = (_a = analysis.programInfo[getResolutionOption(resolutionKind)].moduleKinds) === null || _a === void 0 ? void 0 : _a[(_c = resolution === null || resolution === void 0 ? void 0 : resolution.fileName) !== null && _c !== void 0 ? _c : ""]) === null || _b === void 0 ? void 0 : _b.detectedKind) || ""];
